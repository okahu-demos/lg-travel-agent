...
async def test_flight_booking1(monocle_trace_asserter):
    ...
    monocle_trace_asserter.called_agent("okahu_demo_lg_agent_air_travel_assistant") \
        ...
        .contains_any_output("San Francisco", "SFO","BOM","Mumbai") \
    ...
    monocle_trace_asserter.called_tool("okahu_demo_lg_tool_book_flight","okahu_demo_lg_agent_air_travel_assistant") \
        .contains_input("SFO") \
        .contains_input("BOM") \
        .contains_output("Successfully booked a flight from SFO to BOM") 
    
    monocle_trace_asserter.called_agent("okahu_demo_lg_agent_air_travel_assistant", count=2)
    monocle_trace_asserter.called_agent("okahu_demo_lg_agent_travel_supervisor", count=4)
    monocle_trace_asserter.called_agent("okahu_demo_lg_agent_lodging_assistant", count=0)
